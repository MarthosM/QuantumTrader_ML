"""
Script de Inicialização Automática para Produção (Conta Simulador)
Inicia o sistema completo de trading sem confirmação do usuário
"""
...
def start_trading_system():
    ...
    try:
        ...
        # Iniciar dashboard
        dashboard = RealTimeDashboard(PRODUCTION_CONFIG)
...
def main():
    ...
    print("\n" + "="*80)
    print("QUANTUM TRADER ML - SISTEMA DE PRODUÇÃO AUTOMÁTICO")
    print("="*80)
    ...
    print("   - Kill switch: STOP_TRADING.txt")
    print("\nIniciando sistema automaticamente em 5 segundos...")
